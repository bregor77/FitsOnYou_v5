...
namespace FitsOnYou.User
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        string _name = string.Empty; string _cardNo = string.Empty; string _expiryDate = string.Empty; string _ccv = string.Empty;
        ...
        protected void lbCardSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Session["userId"] != null)
            {
                OrderPayment(_name, _cardNo, _expiryDate, _ccv, _address, _paymentMode);
            }
            else
            {
                Response.Redirect("Login.aspx");
            ...
            try
            {
                ...
                while (dr1.Read())
                {
                    ...
                    if(dbQuantity > _quantity && dbQuantity > 2)
                    {
                        ...
                        cmd = new SqlCommand("Product_Crud", sqlConnection, sqlTransaction);
                        cmd.Parameters.AddWithValue("@Action", "QTYUPATE");
