...
namespace FitsOnYou.User
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        // Custom template class to add controls to the repeater's header, item and footer section.
        private sealed class CustomTemplate : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td><b>No order has been made yet...</b><a href='Menu.aspx' class='badge badge-info ml-2'>Click to Shopping</a></td></tr></tbody></table>");
