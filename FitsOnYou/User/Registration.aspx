<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FitsOnYou.User.Registration" %>
                    ...
                    <div class="form_container">
                        ...
                        <div>                            
                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Address is required"
                                ControlToValidate="txtAddress" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small"></asp:RequiredFieldValidator>
                        ...
                        <div>                            
                            <asp:RequiredFieldValidator ID="rfvPostCode" runat="server" ErrorMessage="Eircode is required"
                            ...
                            <asp:TextBox ID="txtPostCode" runat="server" CssClass="form-control" placeholder="Enter Eircode"
                                ToolTip="Eircode"></asp:TextBox>
                        </div>
