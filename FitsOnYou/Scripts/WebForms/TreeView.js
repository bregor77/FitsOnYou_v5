...
function TreeView_ProcessNodeData(result, context) {
    ...
    if (result.length > 0) {
        ...
        if ((typeof(img) != "undefined") && (img != null)) {
            ...
            if (lineType == "l") {
                img.src = context.data.../TemplateFiles/images[13];
            }
            else if (lineType == "t") {
                img.src = context.data.../TemplateFiles/images[10];
            }
            else if (lineType == "-") {
                img.src = context.data.../TemplateFiles/images[16];
            }
            else {
                img.src = context.data.../TemplateFiles/images[3];
            }
            var pe;
            if (__nonMSDOMBrowser) {
...
function TreeView_ToggleNode(data, index, node, lineType, children) {
    ...
    try {
        if (children.style.display == "none") {
            ...
            if ((typeof(img) != "undefined") && (img != null)) {
                if (lineType == "l") {
                    img.src = data.../TemplateFiles/images[15];
                }
                else if (lineType == "t") {
                    img.src = data.../TemplateFiles/images[12];
                }
                else if (lineType == "-") {
                    img.src = data.../TemplateFiles/images[18];
                }
                else {
                    img.src = data.../TemplateFiles/images[5];
                }
            ...
            if ((typeof(img) != "undefined") && (img != null)) {
                if (lineType == "l") {
                    img.src = data.../TemplateFiles/images[14];
                }
                else if (lineType == "t") {
                    img.src = data.../TemplateFiles/images[11];
                }
                else if (lineType == "-") {
                    img.src = data.../TemplateFiles/images[17];
                }
                else {
                    img.src = data.../TemplateFiles/images[4];
                }
